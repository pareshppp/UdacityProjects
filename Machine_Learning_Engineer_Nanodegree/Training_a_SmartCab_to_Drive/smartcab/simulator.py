        ...
        if self.log_metrics:
            ...
            if a.learning:
                if self.optimized: # Whether the user is optimizing the parameters and decay functions
                    self.log_filename = os.path.join(os.getcwd(),"logs", "sim_improved-learning.csv")
                    self.table_filename = os.path.join(os.getcwd(),"logs","sim_improved-learning.txt")
                else: 
                    self.log_filename = os.path.join(os.getcwd(),"logs", "sim_default-learning.csv")
                    self.table_filename = os.path.join(os.getcwd(),"logs","sim_default-learning.txt")

                self.table_file = open(self.table_filename, 'w')
            else:
                self.log_filename = os.path.join(os.getcwd(),"logs", "sim_no-learning.csv")
